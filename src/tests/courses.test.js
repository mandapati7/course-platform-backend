...
describe("Course Controller", () => {
    ...
    it("should create a new course as an admin", async () => {
      const res = await request(app)
        ...
        .send({
          title: "Admin Course",
          description:
            "This is a test course created by an admin with a sufficiently long description.",
    ...
    it("should not allow regular users to create courses", async () => {
      const res = await request(app)
        ...
        .send({
          title: "User Course",
          description:
            "This course should not be created because regular users cannot create courses.",
          price: 49.99,
          category: "Design",
        });
  ...
  describe("GET /api/v1/courses", () => {
      ...
      await Course.create([
        {
          ...
          description:
            "Learn the basics of JavaScript programming language with practical examples.",
        ...
        },
        {
          ...
          description:
            "Master React with advanced patterns and state management techniques.",
        ...
        },
        {
          ...
          description:
            "Learn digital marketing strategies for business growth.",
    ...
    it("should search courses by keyword", async () => {
      const res = await request(app).get("/api/v1/courses?keyword=React");
    ...
    it("should paginate results", async () => {
      const res = await request(app).get("/api/v1/courses?page=1&limit=2");
...
describe("Course Enrollment", () => {
  ...
  describe("POST /api/v1/courses/:id/enroll", () => {
    it("should enroll a user in a course", async () => {
      ...
      expect(user.enrolledCourses[0].course.toString()).toBe(
        courseId.toString()
      );
    });
  ...
  describe("GET /api/v1/courses/enrolled", () => {
    ...
    it("should require authentication", async () => {
      const res = await request(app).get("/api/v1/courses/enrolled");
    ...
    it("should require authentication when using query parameter", async () => {
      const res = await request(app).get("/api/v1/courses?enrolled=true");
